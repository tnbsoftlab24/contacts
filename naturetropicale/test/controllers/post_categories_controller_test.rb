...
class PostCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_category" do
    assert_difference('PostCategory.count') do
      post post_categories_url, params: { post_category: { parent_id: @post_category.parent_id, title: @post_category.title } }
    end
  ...
  test "should update post_category" do
    patch post_category_url(@post_category), params: { post_category: { parent_id: @post_category.parent_id, title: @post_category.title } }
