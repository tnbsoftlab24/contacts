...
class ProposalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post proposals_url, params: { proposal: { job_id: @proposal.job_id, owner_id: @proposal.owner_id } }
    end
  ...
  test "should update proposal" do
    patch proposal_url(@proposal), params: { proposal: { job_id: @proposal.job_id, owner_id: @proposal.owner_id } }
